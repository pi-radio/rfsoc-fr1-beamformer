...
sdr1 = piradio.sdr.FullyDigital('ip', "192.168.137.43", 'isDebug', isDebug, 'figNum', 100, 'name', 'NAVY DUT', 'fc', 3.56988e9);
sdr1.set_mode('gnb')

sdr2 = piradio.sdr.FullyDigital('ip', "192.168.137.44", 'isDebug', isDebug, 'figNum', 200, 'name', 'NAVY HELPER', 'fc', 3.56988e9);
sdr2.set_mode('gnb')
